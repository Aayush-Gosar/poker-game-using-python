...
def passs(yunhi,client_cards,client_name,client_cards_copy,no_of_clients):
    n=3
...
def table_thread_generator(no_of_clients,table_no):
    print("size of no of clients is :",len(no_of_clients))
    list_cards=[]
    client_cards=[]
    deck=deck_generator()
    ...
    for i in range(0,n):
        messa='Hello welcome to Table no'+str(table_no)
        no_of_clients[i].send(messa.encode('utf-8'))
    ...
    passs(yunhi,client_cards,client_name,client_cards_copy,no_of_clients)
...
# def threaded(no_of_clients):
#     table_thread_generator(no_of_clients)
...
def main():
    ...
    while True:
        ...
        # print(no_of_clients)
        # print_lock.acquire()
        start_new_thread(table_thread_generator, (no_of_clients,table_no)) 
        table_no+=1
